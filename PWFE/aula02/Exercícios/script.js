//Professor, eu passei os parâmetros no próprio código pra não ficar aparecendo a caixinha de prompt toda hora. Os resultados estão no console.

function sorteio(nomes){
    let num = Math.floor(Math.random() * 10);
    console.log("exercicio 1-)", nomes[num])
}
sorteio(["reenye","jao","pedro","gabriel","rafael","igor","richarlison","junior","carlao","josué"]);
...
sorteios(["reenye","jao","pedro","gabriel","rafael","igor","richarlison","junior","carlao","josué"], 5)
